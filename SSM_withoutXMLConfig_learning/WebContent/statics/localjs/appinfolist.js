...
var saleSwitchAjax = function(appId,obj){
	$.ajax({
		type:"PUT",
		url:appId+"/sale.json/" + obj.attr("saleSwitch"),
		//data:{status:obj.attr("saleSwitch")},
		dataType:"json",
		...
		error:function(data){
			if("open" == obj.attr("saleSwitch")){
				alert("抱歉，【"+obj.attr("appsoftwarename")+"】的【上架】操作失败aaaaaaaaaaa");
			}else if("close" == obj.attr("saleSwitch")){
				alert("抱歉，【"+obj.attr("appsoftwarename")+"】的【下架】操作失败aaaaaaaaaaa");
			}
		}
	});
};
